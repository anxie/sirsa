...
POOL_CLASSES = {
    ...
    'PercentileReplayPool': percentile_replay_pool.PercentileReplayPool,
    'MultitaskPercentileReplayPool': percentile_replay_pool.MultitaskPercentileReplayPool,
