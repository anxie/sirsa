...
class GymAdapter(SoftlearningEnv):
    ...
    def reset(self, task_id=-1, sample_id=-1, *args, **kwargs):
        observation = self._env.env.reset(task_id, sample_id)
    ...
    def set_parameters(self, context=None):
        self._env.env._set_parameters(context=context)
