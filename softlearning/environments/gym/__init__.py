...
GENERAL_ENVIRONMENT_SPECS = (
    ...
    {
        'id': 'Reacher2D-Default-v0',
        'entry_point': (f'{CUSTOM_GYM_ENVIRONMENTS_PATH}'
                        '.robust.reacher:ReacherEnv')
    },
    {
        'id': 'Minitaur-Default-v0',
        'entry_point': (f'{CUSTOM_GYM_ENVIRONMENTS_PATH}'
                        '.robust.minitaur:RandomizedMinitaurEnv')
    },
    {
        'id': 'HalfCheetah-Default-v0',
        'entry_point': (f'{CUSTOM_GYM_ENVIRONMENTS_PATH}'
                        '.robust.half_cheetah:RandomizedHalfCheetahEnv')
    },
    {
        'id': 'SawyerPeg2Box-Default-v0',
        'entry_point': (f'{CUSTOM_GYM_ENVIRONMENTS_PATH}'
                        '.robust.sawyer_peg.sawyer_peg:RandomizedSawyerPegInsertion2BoxEnv')
    },
)
